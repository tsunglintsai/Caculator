...
- (CalculatorGraphicViewController*) calculatorGraphicViewController{
    id calculatorGraphicViewController = [self.splitViewController.viewControllers lastObject];
    if(![calculatorGraphicViewController isKindOfClass:[CalculatorGraphicViewController class]]){
        calculatorGraphicViewController = nil;
    }
    return calculatorGraphicViewController;
}
